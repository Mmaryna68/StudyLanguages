...
const WordTable = inject("wordStore")( // Inject the 'wordStore' into the component
observer(({ wordStore, words }) => {
  ...
  const handleSave = () => {
    ...
    const isWordValid =  wordStore.words.some((item) => item.english === trimmedWord);
    ...
    wordStore.onEditWord(editedWordId, trimmedWord, trimmedTranslation);
              ...
              {editedWordId === word.id ? (
                ...
                <>
                  ...
                  <button
                    ...
                    onClick={() =>  wordStore.onDeleteWord(word.id)}
                  >
